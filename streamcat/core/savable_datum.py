...
class SavableDatum(Datum, BaseModel):
    ...
    def find_my_project(self):
        ...
        return DatumFinder(self._session).find_my_project(self.id)
    ...
    def move(self, parent_uuid:str, lock_uuid:str=None, modifier=None):
        ...
        to_folder = DatumFinder(self._session).find_by_uuid(parent_uuid)
    ...
    def _move_imp(self, to_folder, prev_parent_id, modifier=None):
        ...
        try:
            ...
            from_folder = DatumFinder(self._session).find_by_id(prev_parent_id)
