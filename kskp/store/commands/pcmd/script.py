...
class GroupBy2Command(Command):
    ...
    def sumofreoccurringvalues(self, k, precision, **kwargs):
        f = kwargs['f']
        a = kwargs['a']
    ...
    def firstmin(self, k, precision, **kwargs):
        f = kwargs.get('f')
        a = kwargs.get('a')
        x = kwargs.get('x')
    ...
    def firstmax(self, k, precision, **kwargs):
        f = kwargs.get('f')
        a = kwargs.get('a')
        x = kwargs.get('x')
    ...
    def lastmin(self, k, precision, **kwargs):
        f = kwargs.get('f')
        a = kwargs.get('a')
        x = kwargs.get('x')
    ...
    def lastmax(self, k, precision, **kwargs):
        f = kwargs.get('f')
        a = kwargs.get('a')
        x = kwargs.get('x')
